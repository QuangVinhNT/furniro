  ...
  return (
    <div className="relative">
      ...
      <div className="absolute bg-secondary/90 top-1/2 right-4 px-4 py-4 w-[calc(100%-32px)] -translate-y-1/2 rounded-md md:w-[300px] lg:w-[550px] lg:right-12">
        ...
        <Link to={'/'} className="uppercase text-[6px] font-bold text-white bg-primary py-1 px-2 inline-block mt-2 md:text-[10px] md:font-medium md:py-2 md:px-4 md:rounded-md transition-all hover:brightness-110">Buy now</Link>
      </div>
    </div>
  );
};
